...
function Footer() {
    return(
        <div className="Blockreact_Footer">
            <footer className="text-center lg:text-left bg-blue-500 text-slate-50">
            ...
            <a href="#!" className="mr-6 text-slate-50">
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="">
        ...
        <p className="mb-4">
          <a href="#!" className="text-slate-50">All NFTs</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-slate-50">Art</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-slate-50">Collectibles</a>
        </p>
        <p>
          <a href="#!" className="text-slate-50">Domain Names</a>
        </p>
        <p>
          <a href="#!" className="text-slate-50">Music</a>
        </p>
      </div>
      <div className="">
        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
        ...
        <p className="mb-4">
          <a href="#!" className="text-slate-50">EXPLORE</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-slate-50">STATS</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-slate-50">RESOURCES</a>
        </p>
  ...
  <div className="text-center p-6 bg-slate-50">
    ...
    <a className="text-slate-50 font-semibold" href="https://tailwind-elements.com/">Tailwind Elements</a>
  </div>
</footer>
        </div>
